<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orthokhulna.aspx.cs" Inherits="orthokhulna" %>
...
<div class="main-header" id="house">
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td style="font-size: large; font-weight: bold">Orthopedics specialists in Khulna<br />
                <br />
                <br />
                <br />
                Professor Dr. Ibrahim Kholil<br />
                MBBS,MS(ortho)<br />
                Chamber:Labaid Ltd.(Diagnostic),Khulna<br />
                KDA,Plot no. A/5,Majid Sarani,Sonadanga,Khulna<br />
                Phone: 01766661020<br />
                <br />
                <br />
                <br />
                Dr. Md. Mostafujur Rahman<br />
                MBBS,D-Ortho(DU)<br />
                Chamber: Islami Bak Hospital<br />
                42,Khan jahan Ali Road,Khulna<br />
                Phone:01711298607<br />
                <br />
                <br />
                <br />
                Dr. Syed Md. Elius<br />
                MBBS(Dhaka),D Ortho(DU),FRSH(LONDON)<br />
                Chamber: 2, South central road,bi-lane,Khulna<br />
                Phone:01724599480<br />
                <br />
                <br />
                <br />
            </td>
