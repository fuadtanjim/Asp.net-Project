<%@ Page Language="C#" AutoEventWireup="true" CodeFile="healthtips.aspx.cs" Inherits="healthtips" %>
						  ...
						  <div class="top-menu">
							<nav class="menu menu--francisco">
									<ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="healthtips.aspx" class="menu__link"><span class="menu__helper">Health Tips</span></a></li>
                                        <li class="menu__item"><a href="admin.aspx" class="menu__link"><span class="menu__helper">Donar List</span></a></li>
    ...
    <div class="top_banner two">
            <div class="container">
                <div class="sub-hd-inner">
                    <h3 class="tittle">Health <span>Tips</span></h3>

                    <div id="gallery" class="gallery">
                        <div class="container">
                            <div class="gallery_gds w3l">
                                <ul class="simplefilter wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                    <li data-filter="1"><a href="allergy.aspx">Allergy</li>
                                    <li data-filter="1"><a href="appendicitis.aspx">Appendicitis</li>
                                    <li data-filter="2"><a href="cold.aspx">Common cold</li>
                                    <li data-filter="3"><a href="diabetes.aspx">Diabetes</li>
                                    <li data-filter="4"><a href="dehydration.aspx">Dehydration</li>
                                    <li data-filter="4"><a href="dengue.aspx">Dengue</li>
                                </ul>
                            </div>
                        </div>
                    </div>
