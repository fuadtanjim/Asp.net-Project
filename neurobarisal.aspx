<%@ Page Language="C#" AutoEventWireup="true" CodeFile="neurobarisal.aspx.cs" Inherits="neurobarisal" %>
...
<body>
                        ...
                        <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    ...
                                    <li class="menu__item menu"><a href="bloodbank.aspx" class="menu__link"><span class="menu__helper">Blood Bank</span></a></li>
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td style="font-size: large; font-weight: bold">Assoc. Prof. Dr. Sukriti Das<br />
                Associate Professor,Dept. of Neurosurgery,DMCH<br />
                Neurosurgery(Surgery of Brain,Spinal Cord and nerve)<br />
                Medinova Medical Services Ltd.(Barisal),Main Br.,KB Hemayet Uddin Road,Girjamoholla,Sadar,Barisal</td>
        </tr>
    </table>
