<%@ Page Language="C#" AutoEventWireup="true" CodeFile="donate1.aspx.cs" Inherits="donate1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="main-header" id="house">
            <div class="header-strip">
                <div class="container">
                    <p class="location"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <a href="mailto:info@example.com">fuadtanjim@yahoo.com</a></p>
    ...
    <div class="top_banner two">
        <div class="container">
            <div class="sub-hd-inner">
                <h3 class="tittle"><span>Submission succesful</span></h3>
